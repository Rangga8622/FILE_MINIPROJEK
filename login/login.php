		...
		<div class="container-login100">
			<div class="animate__animated animate__fadeInDown">
				<div class="wrap-login100">
					<form class="login100-form validate-form" id="loginForm" method="POST" action="../auth_controller.php">
						<div class="animate__animated animate__jackInTheBox animate__slow">
							<div class="animate__animated animate__pulse animate__infinite	infinite">
								<span class="login100-form-title p-b-26">
									Welcome Website Person
								</span>
							</div>
						</div>
						<div class="animate__animated animate__bounceIn animate__delay-2s">
							<span class="login100-form-title p-b-48">
								<img src="../image/logo_my.png" alt="logo_my" style="width: 25%;">
							</span>
						</div>
						...
						<div class="container-login100-form-btn">
							<div class="wrap-login100-form-btn">
								...
								<button class="login100-form-btn" name="proses" value="login">
									Login
								</button>
							</div>
						</div>
